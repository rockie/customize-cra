...
export default [
    {
        ...
        plugins: [
            ...
            // rk: command-line tools only used in dev mode, not necessary to minifies the codebase
            //terser(),

            // produces sourcemaps for the produced code (rk: not work at all, when terser is turned on, just got a mess of error info)
            sourcemaps(),
        ],
    },
];
